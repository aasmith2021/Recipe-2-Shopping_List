...
CREATE TABLE custom_measurement_units
(
	cmu_id						INT					IDENTITY(1,1),
	recipe_book_library_id		INT					NOT NULL,
	measurement_unit_name		VARCHAR (30)		NOT NULL,
	CONSTRAINT PK_custom_measurement_units PRIMARY KEY (cmu_id),
	CONSTRAINT FK_custom_measurement_units_recipe_book_library FOREIGN KEY (recipe_book_library_id) REFERENCES recipe_book_library(rbl_id)
);
...
INSERT INTO recipe_book_library (last_saved) VALUES ('1800-01-01');
